...
export function HeroSection() {
  ...
  return (
    <section id="intro" className="flex min-h-[calc(100svh-5.25rem)] flex-col">
      <Container className="flex flex-1 flex-col justify-center py-16 md:py-20">
        ...
        <FadeUp delay={0.35} className="mt-10 max-w-2xl">
          <div className="flex gap-5 border-l border-edge pl-5 sm:gap-6 sm:pl-6">
            <div
              aria-hidden="true"
              className="hidden flex-col gap-2 pt-1 font-mono text-[10px] leading-relaxed text-muted/60 select-none sm:flex"
            >
